...
public class MapCollider : MonoBehaviour
{
    ...
    //THIS METHOD IS COMPLETELY OBSOLETE PLEASE DO NOT RE-ENABLE THESE OPTIONS

    private string shorthandCollisionMap = "0x4";
    private int width = 2;
    ...
    public void GenerateCollisionTexture()
    {
        ...
        //GlobalVariables.global.debug($"Done{width}{length}  {collisionMap[5,5]}: {collisionVisual.GetPixel(5, 5)}");
    }
